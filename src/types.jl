...
Basic geometry used to represent borders of countries/regions on Earth's surface, supporting fast check for point inclusion.

This type is used to represent the borders of countries and other regions.
"""
